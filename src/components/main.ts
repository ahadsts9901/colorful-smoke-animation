export const bootstrap = () => {
    ...
    function getWebGLContext(canvas: any) {
        // Initialize WebGL context and check for floating-point support
    ...
    class PointerPrototype {
        ...
        down: boolean = false;
        moved: boolean = false;
        color: [number, number, number] = [300, 300, 300];
        ...
        class GLProgram {
            ...
            constructor(vertexShader: WebGLShader, fragmentShader: WebGLShader) {
                ...
                if (!gl.getProgramParameter(this.program, gl.LINK_STATUS)) {
                    throw new Error(gl.getProgramInfoLog(this.program) || "Unknown error linking program");
                }
            ...
            // Add the bind method to the class
            public bind(): void {
    ...
    var textureWidth: any = void 0;
    var textureHeight: any = void 0;
    var density: any = void 0;
    var velocity: any = void 0;
    var divergence: any = void 0;
    var curl: any = void 0;
    var pressure: any = void 0;
    ...
    function createFBO(texId: any, w: any, h: any, internalFormat: any, format: any, type: any, param: any) {
    ...
    function createDoubleFBO(texId: any, w: any, h: any, internalFormat: any, format: any, type: any, param: any) {
    ...
    function m(t: any) {
        ...
        for (var e, n: any = document.getElementById(t), i = n.innerHTML.replace("&amp;", "&").split(""), a = "", o = 0, s = i.length; s > o; o++) {
            e = i[o].replace("&", "&amp");
